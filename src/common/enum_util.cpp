...
const StringUtil::EnumStringLiteral *GetExpressionClassValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(ExpressionClass::BOUND_COMPREHENSION), "BOUND_COMPREHENSION" }
	};
	return values;
}
...
const StringUtil::EnumStringLiteral *GetExpressionTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(ExpressionType::BOUND_COMPREHENSION), "BOUND_COMPREHENSION" }
	};
	return values;
}
...
const StringUtil::EnumStringLiteral *GetMetricTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(MetricType::OPTIMIZER_PRENEST_FILTER_PUSHDOWN), "OPTIMIZER_PRENEST_FILTER_PUSHDOWN" },
...
const StringUtil::EnumStringLiteral *GetOptimizerTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(OptimizerType::PRENEST_FILTER_PUSHDOWN), "PRENEST_FILTER_PUSHDOWN" }
	};
	return values;
}
